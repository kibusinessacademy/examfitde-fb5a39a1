...
BEGIN
  ...
  -- Bloom/cognitive level distribution hash
  ...
  -- Mode distribution hash (replaces question_type which doesn't exist)
  ...
  -- Explanation coverage (pct of approved with explanation >= 40 chars)
