...
SELECT
  ...
  CASE
    WHEN b.bezeichnung_kurz IS NOT NULL THEN
      ...
      CASE b.zustaendigkeit WHEN 'IH' THEN 'IHK' WHEN 'Hw' THEN 'HWK' ELSE COALESCE(b.zustaendigkeit, '') END ||
      '-Abschlussprüfung als ' || b.bezeichnung_kurz ||
      ' – mit Simulation, KI-Coach und Schwächenanalyse.'
    ELSE
      'Prüfungstraining mit Simulation, KI-Coach und adaptiver Schwächenanalyse.'
