...
BEGIN
  ...
  -- TEST 1: building→queued blocked (non-whitelisted source raises EXCEPTION; we catch and verify state)
  ...
  -- TEST 4: admin bypass via 'admin_force_publish' (whitelisted by both guard layers)
