...
-- RPC: Efficient aggregated question count per learning field
...
-- RPC: Currently processing heavy jobs per package (concurrency guard)
...
AS $$
  SELECT
    coalesce(jq.payload->>'package_id', '') AS package_id,
