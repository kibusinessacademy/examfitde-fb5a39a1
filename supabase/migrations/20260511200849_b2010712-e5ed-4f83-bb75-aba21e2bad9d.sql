...
BEGIN
  ...
  VALUES (gen_random_uuid(), v_pkg_id, 'run_integrity_check', 'done', now() - interval '3 hours')
  ...
  RETURN jsonb_build_object('ok', v_failed = 0, 'passed', v_passed, 'failed', v_failed, 'skipped', v_skipped, 'results', v_results, 'curriculum_id', v_curriculum_id);
