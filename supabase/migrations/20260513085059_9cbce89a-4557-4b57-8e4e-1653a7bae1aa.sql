...
DECLARE
  ...
  rec record; _job_type text; _idem text; _new_job_id uuid; _curriculum_id uuid;
    ...
    ELSIF p_dry_run THEN
      ...
      VALUES('exam_pool_repair_dispatch_dryrun','package',rec.package_id::text,'success',
        jsonb_build_object('run_id',_run_id,'heal_class',rec.heal_class,'job_type',_job_type,
          ...
          'idempotency_key',_idem,'approved_q',rec.approved_q,'curriculum_id',_curriculum_id,
    ...
    ELSE
      BEGIN
        ...
        VALUES(_job_type,'pending',55,
          jsonb_build_object(
            'package_id',rec.package_id,'curriculum_id',_curriculum_id,
            '_origin','admin_dispatch_exam_pool_repair',
        ...
        VALUES('exam_pool_repair_dispatched','package',rec.package_id::text,
          ...
          jsonb_build_object('run_id',_run_id,'heal_class',rec.heal_class,'job_type',_job_type,
            'job_id',_new_job_id,'idempotency_key',_idem,'curriculum_id',_curriculum_id,
      ...
      EXCEPTION WHEN OTHERS THEN
        ...
        VALUES('exam_pool_repair_skipped','package',rec.package_id::text,'error',
          jsonb_build_object('run_id',_run_id,'heal_class',rec.heal_class,'job_type',_job_type,
            'idempotency_key',_idem,'curriculum_id',_curriculum_id,'error',SQLERRM));
      END;
    END IF;
