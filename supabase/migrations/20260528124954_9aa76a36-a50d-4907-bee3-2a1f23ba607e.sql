CREATE OR REPLACE FUNCTION public.verwaltung_daily_brief_workflow_pressure(_window_days integer DEFAULT 7)
 RETURNS jsonb
 LANGUAGE plpgsql
...
BEGIN
  ...
  joined AS (
    SELECT d.department_key, d.department_name AS display_name,
