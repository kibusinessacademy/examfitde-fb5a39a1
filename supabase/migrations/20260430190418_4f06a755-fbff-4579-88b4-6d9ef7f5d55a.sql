...
CREATE OR REPLACE FUNCTION public.admin_seo_batch_apply_strong_matches(p_min_score numeric DEFAULT 0.70, p_limit integer DEFAULT 25, p_dry_run boolean DEFAULT false)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
