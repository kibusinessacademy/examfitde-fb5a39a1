...
BEGIN
  FOR r IN
    SELECT curriculum_id, curriculum_title, review_pending, review_tier1_passed, promotable_drafts, total_approved, oldest_review_pending_hours, backlog_health
  ...
  RETURN jsonb_build_object('escalated', escalated, 'checked_at', now(), 'details', results);
END;
$$;
