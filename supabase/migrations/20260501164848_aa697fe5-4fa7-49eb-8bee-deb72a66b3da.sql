-- Restore original process_order_paid_fulfillment + Bundle-Loop für Grants
...
BEGIN
  ...
  -- ==========================================================================
  -- GRANTS: pro distinct (curriculum_id, product_id) — Bundle-Fix
  -- (vorher: LIMIT 1 → nur erstes Item bekam Grant)
  -- ==========================================================================
  ...
  -- Erstes (curriculum_id, product_id) für CRM/Audit-Felder
  ...
  -- ==========================================================================
  -- INVOICE_ITEMS (Originalspalten: order_id, unit_price_cents, total_cents)
  -- ==========================================================================
  ...
  BEGIN
    ...
    VALUES ('order_paid_fulfillment_v5_bundle', 'order', v_order.id, 'success',
            jsonb_build_object(
              'order_id', v_order.id,
