...
BEGIN
  ...
  -- Bypass pricing/status/publish guards for ephemeral test fixture
  PERFORM set_config('session_replication_role', 'replica', true);

  v_curr := gen_random_uuid(); v_pkg := gen_random_uuid();
  INSERT INTO public.curricula (id, title, status, program_type)
  VALUES (v_curr, '__smoke_handbook__', 'draft'::curriculum_status, 'vocational');
