-- Expose a stable title column on the admin package SSOT view so
-- existing admin cards can render human-readable course names instead of
-- package UUID fragments.
