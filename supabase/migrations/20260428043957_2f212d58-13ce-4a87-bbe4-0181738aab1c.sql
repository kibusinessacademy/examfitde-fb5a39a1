-- Forensic 24h Heal v2 (correct auto_heal_log schema)
DO $$
DECLARE
  r RECORD;
  v_active INT;
  ...
  v_skip_count INT := 0;
  v_fail_count INT := 0;
  v_action TEXT := 'FORENSIC_24H_HEAL_2026_04_28';
...
BEGIN
  ...
  -- Reap stale running/processing jobs (>2h, no heartbeat) — frees WIP
  UPDATE job_queue
  ...
  RAISE NOTICE 'FORENSIC_24H_HEAL_2026_04_28: healed=%, skipped=%, failed=%', v_heal_count, v_skip_count, v_fail_count;
END $$;