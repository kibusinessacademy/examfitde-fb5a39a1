...
-- Fix normalize_qualification_title: convert umlauts BEFORE stripping non-ascii
...
BEGIN
  ...
  -- Remove gender suffixes: /-in, /-r, /-e, (m/w/d) etc.
  v := regexp_replace(v, '\s*/\-?(?:in|r|e|er|erin)\b', '', 'g');
