...
DECLARE
  v_pkg_id uuid; v_curriculum_id uuid;
...
BEGIN
  ...
  INSERT INTO public.course_packages(id, package_key, title, status, curriculum_id, created_at, updated_at)
  VALUES (v_pkg_id, 'smoke_tail_heal_'||substr(v_pkg_id::text,1,8), 'smoke', 'building', v_curriculum_id, now(), now());
