...
import type { HandbookChapter, HandbookProgress } from '@/hooks/handbook';
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <span>{chapter.estimated_reading_minutes ?? 0} Min. Lesezeit</span>
            </div>
          ...
          {hasAccess && <Progress value={progressPercent} className="h-1.5" />}
