...
const VERDICT_CONFIG: Record<Verdict, { label: string; className: string }> = {
  exam_ready:   { label: "Prüfungsreif",  className: "bg-success-bg-subtle text-success border-success/30" },
  almost_ready: { label: "Fast bereit",   className: "bg-warning-bg-subtle text-warning border-warning/30" },
  needs_work:   { label: "Aufholbedarf",  className: "bg-[hsl(25,95%,53%)]/15 text-[hsl(25,95%,53%)] border-[hsl(25,95%,53%)]/30" },
  not_ready:    { label: "Nicht bereit",   className: "bg-destructive-bg-subtle text-destructive border-destructive/30" },
