...
import { AlertTriangle, Wrench, Eye, Zap, ShieldOff, Loader2 } from 'lucide-react';
  ...
  return (
    <Card>
        ...
        <div className="flex items-center justify-between">
          ...
          {autoHealable.length > 0 && (
            <Button
              ...
              disabled={healAction.isPending || !diagnosis.auto_heal_allowed}
            ...
            >
              ...
              Alle auto-reparieren ({autoHealable.length})
            </Button>
          )}
        </div>
      </CardHeader>
      <CardContent className="space-y-2">
        ...
        {!diagnosis.auto_heal_allowed && autoHealable.length > 0 && (
