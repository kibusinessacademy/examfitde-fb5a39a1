...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      beruf_market_data: {
        Row: {
          ...
          est_annual_revenue_eur: number
          est_arpu_eur: number
          est_penetration_pct: number
          fit_score: number
        ...
        Relationships: [
          {
            foreignKeyName: "beruf_market_data_beruf_id_fkey"
            columns: ["beruf_id"]
            isOneToOne: true
            referencedRelation: "berufe"
            referencedColumns: ["id"]
      ...
      drift_snapshots: {
        Row: {
          ...
          avg_praxis_score: number | null
          avg_quality_score: number | null
          created_at: string
          drift_alert: boolean | null
        ...
        Relationships: [
          {
            ...
            columns: ["package_id"]
            isOneToOne: false
            referencedRelation: "corporate_seat_utilization"
            referencedColumns: ["license_package_id"]
          },
          {
            foreignKeyName: "license_seats_package_id_fkey"
            columns: ["package_id"]
      ...
      outcome_tracking: {
        Row: {
          ...
          pass_simulation_at: string | null
          scores_14d: number[] | null
          scores_30d: number[] | null
          scores_7d: number[] | null
          updated_at: string
          user_id: string
        }
        Insert: {
      ...
      user_skill_scores: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_skill_scores_skill_node_id_fkey"
            columns: ["skill_node_id"]
            isOneToOne: false
            referencedRelation: "skill_nodes"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            columns: ["beruf_id"]
            isOneToOne: false
            referencedRelation: "work_berufe"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      work_bundle_assets: {
        ...
        Relationships: [
          {
            foreignKeyName: "berufski_bundle_assets_bundle_id_fkey"
            columns: ["bundle_id"]
            isOneToOne: false
            referencedRelation: "work_bundles"
            referencedColumns: ["id"]
          },
        ]
      }
      work_bundle_purchases: {
        Row: {
        ...
        Relationships: [
          {
            ...
            columns: ["purchase_id"]
            isOneToOne: false
            referencedRelation: "work_purchases"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      work_cover_assets: {
        ...
        Relationships: [
          {
            foreignKeyName: "berufski_cover_assets_beruf_id_fkey"
            columns: ["beruf_id"]
            isOneToOne: false
            referencedRelation: "work_berufe"
            referencedColumns: ["id"]
      ...
      work_license_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "berufski_license_events_license_id_fkey"
            columns: ["license_id"]
            isOneToOne: false
            referencedRelation: "work_licenses"
            referencedColumns: ["id"]
          },
        ]
      }
      work_license_keys: {
        ...
        Relationships: [
          {
            foreignKeyName: "berufski_license_keys_license_id_fkey"
            columns: ["license_id"]
            isOneToOne: false
            referencedRelation: "work_licenses"
            referencedColumns: ["id"]
      ...
      work_licenses: {
        ...
        Relationships: [
          {
            foreignKeyName: "berufski_licenses_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "work_organizations"
            referencedColumns: ["id"]
          },
        ]
      }
      work_org_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "berufski_org_members_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "work_organizations"
            referencedColumns: ["id"]
      ...
      work_pdf_exports: {
        ...
        Relationships: [
          {
            foreignKeyName: "berufski_pdf_exports_bundle_id_fkey"
            columns: ["bundle_id"]
            isOneToOne: false
            referencedRelation: "work_bundles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "berufski_pdf_exports_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "work_produkte"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "berufski_pdf_exports_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "work_pdf_templates"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "berufski_pdf_exports_theme_id_fkey"
            columns: ["theme_id"]
            isOneToOne: false
            referencedRelation: "work_brand_themes"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      work_produkte: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "berufski_produkte_cover_asset_id_fkey"
            columns: ["cover_asset_id"]
            isOneToOne: false
            referencedRelation: "work_cover_assets"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "berufski_produkte_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "work_pdf_templates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "berufski_produkte_theme_id_fkey"
            columns: ["theme_id"]
            isOneToOne: false
            referencedRelation: "work_brand_themes"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      exam_questions_elite_v: {
        Row: {
          ai_generated: boolean | null
          annotation_ts: string | null
          approved_version_id: string | null
          bloom_level_validated: string | null
          blueprint_id: string | null
          cognitive_level: string | null
          ...
          distractor_meta: Json | null
          distractor_types: string[] | null
          distractor_types_eff: string[] | null
          dynamic_scenario: boolean | null
          elite_breakdown: Json | null
          elite_level: Database["public"]["Enums"]["elite_level"] | null
          elite_level_eff: Database["public"]["Enums"]["elite_level"] | null
          elite_score: number | null
          elite_score_breakdown: Json | null
          elite_score_eff: number | null
          exam_part: string | null
          explanation: string | null
          id: string | null
          item_calibrated_at: string | null
          ...
          learning_field_id: string | null
          multi_variable: boolean | null
          multi_variable_eff: boolean | null
          normalized_hash: string | null
          options: Json | null
          qc_status: string | null
          ...
          time_estimate_seconds: number | null
          transfer_variant: boolean | null
          transfer_variant_eff: boolean | null
          trap_tags: string[] | null
          typical_errors: Json | null
          variant_group: string | null
          variant_label: string | null
      ...
      ops_batch_requeue_summary: {
        Row: {
          cursor_null: number | null
          distinct_cursors: number | null
          first_seen: string | null
          job_type: string | null
          last_seen: string | null
      ...
      ops_course_build_progress: {
        Row: {
          attempts_sum: number | null
          build_progress: number | null
          current_step: number | null
          is_stuck: boolean | null
          last_activity_at: string | null
      ...
      ops_curriculum_quality_dashboard: {
        Row: {
          approved_blueprints: number | null
          approved_questions: number | null
          avg_exam_relevance_score: number | null
          avg_exam_score: number | null
          avg_total_score: number | null
          bloom_analyze: number | null
          bloom_apply: number | null
          bloom_create: number | null
          bloom_evaluate: number | null
          bloom_levels_covered: number | null
          bloom_remember: number | null
          bloom_understand: number | null
          blueprint_approval_rate_pct: number | null
          blueprint_coverage_pct: number | null
          competencies_total: number | null
          competencies_with_blueprint: number | null
          curriculum_id: string | null
          curriculum_status:
            | Database["public"]["Enums"]["curriculum_status"]
            | null
          curriculum_title: string | null
          curriculum_track: Database["public"]["Enums"]["product_track"] | null
          curriculum_updated_at: string | null
          easy_pct: number | null
          enrichment_competencies_total: number | null
          enrichment_competencies_v2: number | null
          enrichment_v2_pct: number | null
          hardish_pct: number | null
          packages_last_update: string | null
          packages_published: number | null
          packages_qg_failed: number | null
          packages_total: number | null
          packages_with_published_at: number | null
          pkg_examfirst_cnt: number | null
          pkg_full_cnt: number | null
          pkg_integrity_failed: number | null
          pkg_integrity_passed: number | null
          pkg_legacy_reports: number | null
          pkg_null_reports: number | null
          q_easy: number | null
          q_hard: number | null
          q_medium: number | null
          q_very_hard: number | null
          total_blueprints: number | null
        }
        Relationships: []
      }
      ops_curriculum_quality_dashboard_mv: {
        Row: {
          approved_blueprints: number | null
          approved_questions: number | null
          avg_exam_relevance_score: number | null
      ...
      ops_runner_integrity: {
        Row: {
          ...
          leases_active_no_work: number | null
      ...
      package_economics: {
        Row: {
          ...
          roi_30d: number | null
          status: string | null
          tokens_in_30d: number | null
          tokens_out_30d: number | null
        }
        Relationships: [
          {
            foreignKeyName: "course_packages_course_id_fkey"
      ...
      v_admin_visible_course_packages: {
        Row: {
          ...
          curriculum_id: string | null
          elite_hardened_at: string | null
          elite_hardening_version: number | null
          exam_structure: string | null
          feature_flags: Json | null
          id: string | null
          integrity_passed: boolean | null
          ...
          last_progress_at: string | null
          locked_at: string | null
          pipeline_mode: Database["public"]["Enums"]["pipeline_mode"] | null
          priority: number | null
          product_id: string | null
          published_at: string | null
          quality_report: Json | null
      ...
      v_b2b_metrics: {
        Row: {
          ...
          certifications_bought: number | null
      ...
      v_beruf_priority: {
        Row: {
          ...
          est_annual_revenue_eur: number | null
          est_arpu_eur: number | null
          est_penetration_pct: number | null
          is_manual_override: boolean | null
          market_score: number | null
          market_updated_at: string | null
          occupation_name: string | null
          priority_rank: number | null
          suggested_package_priority: number | null
          tier: number | null
        }
        Relationships: []
      }
      ...
      v_package_build_priority: {
        Row: {
          ...
          est_annual_revenue_eur: number | null
          market_priority_rank: number | null
          market_score: number | null
          package_id: string | null
          package_title: string | null
          priority: number | null
      ...
      v_package_publish_readiness: {
        Row: {
          approved_questions: number | null
          course_id: string | null
          cv_approved: number | null
          lessons_placeholder: number | null
          lessons_qc_approved: number | null
          lessons_real: number | null
        ...
        Insert: {
          approved_questions?: never
          course_id?: string | null
          cv_approved?: never
          lessons_placeholder?: never
          lessons_qc_approved?: never
          lessons_real?: never
          lessons_total?: never
          package_id?: string | null
          status?: string | null
      ...
      v_profit_forecast: {
        Row: {
          ...
          forecast_10x: number | null
          forecast_2x: number | null
          forecast_5x: number | null
