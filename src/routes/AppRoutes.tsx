  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      ...
      <Routes>
        ...
        {/* KIMI.2 Phase-A Fix: /app/exam-simulation rendert die Learner-Prüfungssimulation
            DIREKT (bare, ohne MainLayout-Marketing-Chrome). Vorher redirected nach
            /exam-simulation → MainLayout → Footer + Public-Nav → CTA-Inflation (40).
            Jetzt: gleiche Komponente, sauberer Learner-Surface-Kontext.
            /exam-simulation bleibt als Public-Alias (Marketing/SEO) erhalten. */}
        <Route path="/app/exam-simulation" element={<ExamSimulation />} />
        <Route path="/app/exam-simulation/:sessionId" element={<ExamSimulation />} />
