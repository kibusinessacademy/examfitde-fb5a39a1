...
export default function QualityIntelligencePage() {
  ...
  const decide = async (id: string, status: "approved" | "rejected") => {
    ...
    toast({ title: `Empfehlung ${status === "approved" ? "angenommen" : "abgelehnt"}` });
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            ...
            Reparaturen werden ausschließlich vom Menschen freigegeben.
          </p>
        </div>
      </div>
              ...
              <CardContent className="p-4 space-y-2">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex flex-col gap-2 shrink-0">
                    <Button size="sm" onClick={() => decide(r.id, "approved")}>Annehmen</Button>
