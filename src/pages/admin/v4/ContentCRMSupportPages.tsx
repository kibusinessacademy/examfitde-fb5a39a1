    ...
    <div className="space-y-6">
      ...
      <Card className="border-dashed">
        <CardContent className="py-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">CRM wird in Phase 3 implementiert.</p>
          <p className="text-xs text-muted-foreground mt-1">Buyer ≠ Learner · Segmente (Azubi/Betrieb/Schule) · Churn Risk · Nudges</p>
        </CardContent>
      </Card>
    </div>
  );
    ...
    <div className="space-y-6">
      ...
      <Card className="border-dashed">
        <CardContent className="py-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">Support-System wird in Phase 3 implementiert.</p>
          <p className="text-xs text-muted-foreground mt-1">Ticket Inbox · Auto-Vorschläge via KI · FAQ-Knüpfung · SLA Tracking</p>
        </CardContent>
      </Card>
    </div>
  );
