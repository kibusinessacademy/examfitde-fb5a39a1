      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['2', 'generate_learning_content', 'Generiert Lerninhalte für alle Lektionen', 'Step 1 done'],
            ['3', 'validate_learning_content', 'Validiert Lerninhalte (Platzhalter, Tiefe)', 'Step 2 done'],
            ['4', 'auto_seed_exam_blueprints', 'Extrahiert Blueprint-Strukturen aus Kompetenzen', 'Step 3 done'],
            ['5', 'validate_blueprints', 'Prüft Coverage, Verteilung, Schema, Duplikate', 'Step 4 done'],
            ['6', 'generate_exam_pool', 'Generiert Prüfungsfragen (Batching)', 'Step 5 done'],
            ['7', 'validate_exam_pool', 'Tier 1+2 Quality Gate für Prüfungsfragen', 'Step 6 done'],
            ['8', 'generate_oral_exam', 'Erstellt mündliche Prüfungsfragen', 'Step 5 done'],
            ['9', 'validate_oral_exam', 'Validiert mündliche Prüfungsinhalte', 'Step 8 done'],
            ['10', 'build_ai_tutor_index', 'Baut den AI-Tutor Kontext-Index', 'Step 3 done'],
            ['11', 'validate_tutor_index', 'Prüft Coverage, Chunks, Freshness, Leakage', 'Step 10 done'],
            ['12', 'generate_handbook', 'Generiert das Prüfungshandbuch', 'Step 3 done'],
            ['13', 'validate_handbook', 'Validiert Handbuch-Tiefe und Struktur', 'Step 12 done'],
            ['14', 'run_integrity_check', 'Gesamtprüfung aller Artefakte (Sync-Gate)', 'Steps 7-13 done'],
            ['15', 'quality_council', 'KI-basierte Qualitätsbewertung', 'Step 14 done'],
            ['16', 'auto_publish', 'Automatische Veröffentlichung', 'Step 15 passed'],
          ],
        },
      },
      {
