...
export default function WorkBuyPage() {
      ...
      <Card className="max-w-md w-full">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="email" type="email" placeholder="deine@email.de" value={email} onChange={(e) => setEmail(e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="coupon">Coupon (optional)</Label>
            <Input id="coupon" placeholder="z.B. START10" value={coupon} onChange={(e) => setCoupon(e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="affiliate">Affiliate Code (optional)</Label>
            <Input id="affiliate" placeholder="z.B. EXAMFIT" value={affiliate} onChange={(e) => setAffiliate(e.target.value)} />
          </div>
