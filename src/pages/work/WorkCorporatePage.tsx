...
export default function WorkCorporatePage() {
  ...
  return (
    <main className="mx-auto max-w-xl p-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">{BRAND.name} Corporate Lizenz</CardTitle>
          <CardDescription>
            Für Teams, Unternehmen &amp; Behörden. Nach Zahlung erhältst du automatisch Lizenz-Key + Download.
          </CardDescription>
        </CardHeader>
