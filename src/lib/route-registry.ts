...
export const ROUTE_PATTERNS: readonly string[] = [
  ...
  "/bundle",
  "/bundle/:slug",
  // Reality-QA / Public-Funnel stable surfaces + legacy redirects
  "/tutor",
  "/ai-tutor",
  "/oral",
  "/muendlich",
  ...
  // Registry-drift catch-up (routes exist in AppRoutes.tsx, mirror was stale)
  "/produkte",
  "/branchen",
  "/branchen/:slug",
  "/branchen/verwaltung",
  "/admin/governance/agents",
  "/admin/verwaltung/agents",
  "/admin/verwaltung/cockpit",
  "/admin/verwaltung/daily-brief",
  "/admin/berufs-ki/business-intents",
  "/admin/berufs-ki/fix-queue",
  "/admin/berufs-ki/outcome-control",
  "/admin/berufs-ki/outcome-intelligence",
  "/admin/berufs-ki/persona-sim",
  "/admin/berufs-ki/mission-control",
  "/os/conversation",
  "/os/hr-interview",
  "/os/hr-interview/history",
  "/app/beruf-agent-os",
  "/app/org",
  "/app/org/*",
  "/berufski/corporate",
