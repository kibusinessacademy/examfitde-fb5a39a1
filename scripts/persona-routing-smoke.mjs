...
const pageSrcReread = readFileSync(pagePath, "utf8");
...
if (pageSrcReread.includes("personaContext.diagnoseTargetPath")) ok("Page nutzt diagnoseTargetPath aus Context");
